...
public class VideoView extends SurfaceView implements MediaPlayerControl {
    ...
    private int mDefaultW;//默认宽度
    private int mDefaultH;//默认高度
...
//    };
    ...
    private boolean isFullScreen;//默认非全屏
    ...
    public void switchFullScreen() {
    	...
    	requestLayout();//刷新当前控件 重新布局(onlayout/onMeasure/onDraw)
//    	invalidate();//刷新当前控件 重新绘制(onDraw)
    }
